...
$googleClientID = '921685036238-cnbv7lec6a5kdtl8ggi55c4cvs05nkub.apps.googleusercontent.com';
$googleClientSecret = '';
...
$baseURL = 'https://webappwieliczka.azurewebsites.net';
...
if(!isset($_GET['action'])) {
  if(!empty($_SESSION['user_id'])) {
    ...
    echo '<h3>ID Token</h3>';
    echo '<p>ID Token: '.$_SESSION['id_token'].'</p>';
    echo '<pre>';
